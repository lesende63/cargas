...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "transparent" }}>
      ...
      <header className="border-b" style={{ borderColor: "rgba(212,175,55,0.2)", backgroundColor: "#0A1526" }}>
      ...
      <footer className="border-t mt-6 py-5 text-center" style={{ borderColor: "rgba(212,175,55,0.2)", backgroundColor: "#0A1526" }} data-testid="app-footer">
